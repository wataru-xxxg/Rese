        ...
        <section class="left-section">
            ...
            <div class="restaurant-info">
                ...
                <div class="image-container">
                    <img src="@if(str_starts_with($shop->image_path, 'image/')){{ Storage::url($shop->image_path) }}@else{{ Storage::disk('s3')->url($shop->image_path) }}@endif" alt="イメージ画像" class="restaurant-image">
                </div>
